...
RUN sed -i 's/#tomcat.util.http.parser.HttpParser.requestTargetAllow/tomcat.util.http.parser.HttpParser.requestTargetAllow/g' /opt/webserver/conf/catalina.properties
RUN set -x && \
